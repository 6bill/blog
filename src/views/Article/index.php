                ...
                <div class="blockCard">
                    <div class="card">
                        <div class="top">
                            ...
                            <p>
                            <form action="/dashboard/like/">
                                <input type="hidden" name="IDARTICLE" value="<?php echo escape($article->getId_article()); ?>">
                                <input type="hidden" name="IDPSEUDO" value="<?php echo escape($article->getPseudoUser()); ?>">
                        ...
                        <form action="/dashboard/<?php echo escape($article->getId_article()); ?>/commentaire" method="post" enctype='multipart/form-data' id="comment">
